...
* Community supporter: Reaches out to domain scientists who have the potential  of becoming new virtual lab principal investigators.
...
### From initial proposal to co-development
To transition from initial proposal to co-development the following should be done:
