...
<ul style={{ listStyleType: 'none' }}>
    <li> <Downward_arrow/> [L0 - Initial proposal](readiness_levels/L0_initial_proposal): The initial proposal of a virtual lab, with conceptual definition but no technical setup. </li>
