...
* **Virtual lab usage roles:** Roles of people who use an existing virtual lab for their own research.
  * [Golden user](Virtual_lab_roles/Golden_user): Provides a scientific scenario that can best be investigated in NaaVRE. Is involved in developing a
...
* **Virtual lab development roles:** Roles involved in the creation of a new virtual lab.
  * [Virtual lab principal investigator](Virtual_lab_roles/Principal_investogator): Coordinates the development of the virtual lab with a scientific vision.
  This will often be the golden user, i.e. the person that provides the initial publishable use case of the virtual lab.
  * [Virtual lab core developers](Virtual_lab_roles/Core_developer): Develop a new virtual lab in NaaVRE. Often the virtual lab owner will be one of the core developers.
...
* **Virtual lab support roles:** Roles to support development and use of virtual labs.
  ...
  * [Virtual lab trainer](Virtual_lab_roles/Trainer): Knows the lab from a user viewpoint and provides trainings to new users. This role will often be assigned to a person who is also the virtual lab owner, a core developer, or service operator.
  * [Virtual lab coordinator](Virtual_lab_roles/Coordinator): Knows the lab from a technical perspective and pushes the lab to the next readiness level. Often, this will be an employee at LifeWatch ERIC VLIC
  ...
  * [VRE researcher](Virtual_lab_roles/VRE_researcher): Contribute state-of-the-art components to the NaaVRE and can publish technical papers
...
<ul style={{ listStyleType: 'none' }}>
    ...
    <li> <Downward_arrow text="L1"/> [Co-development](readiness_levels/L1_co-development): <div>A provisioned virtual lab is ready for the development team to implement the virtual lab functionality, e.g. new components, workflows, or experiments. </div></li>
...
*Figure 2: Timeline per readiness level showing what roles are involved in what stage.*
