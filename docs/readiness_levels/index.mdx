...
* **Virtual lab usage roles:** Roles for the domain scientists using the virtual lab for their own research.
  * [Golden user](readiness_levels/Virtual_lab_roles/Golden_user): Provides a scientific scenario that be well investigated in NaaVRE. Is involved in developing a
...
* **Virtual lab development roles:** Roles involved in the creation of a new virtual lab.
  * [Virtual lab core developers](readiness_levels/Virtual_lab_roles/Core_developer): Develop a new virtual lab in NaaVRE. Often the virtual lab owner will be one of the core developers. Core developers are provided or hired by the golden user.
  * [Virtual lab code reviewers](readiness_levels/Virtual_lab_roles/Reviewer): Provide feedback during co-development on the user-friendliness, maintainability, and robustness of the
  source code and other assets.
  * [Scientific steering board](readiness_levels/Virtual_lab_roles/Steering_board): Coordinates the development of the virtual lab with a scientific vision.
* **Virtual lab support roles:** Roles to support development and use of virtual labs.
  * [Community supporter](readiness_levels/Virtual_lab_roles/Community_supporter): Forms connections between users and the virtual lab.
  * [Virtual lab trainer](readiness_levels/Virtual_lab_roles/Trainer): Knows the lab from a user viewpoint and provides trainings to new users.
  * [Virtual lab coordinator](readiness_levels/Virtual_lab_roles/Coordinator): Knows the lab from a technical perspective and pushes the lab to the next readiness level if there is a user community. Often, this will be an employee at LifeWatch ERIC VLIC
  * [Virtual research environment development and operations (VRE DevOps) engineer](readiness_levels/Virtual_lab_roles/DevOps): Maintains NaaVRE. Often, this will be an employee at LifeWatch ERIC VLIC.
  * [VRE researcher](readiness_levels/Virtual_lab_roles/VRE_researcher): Contributes state-of-the-art components to the NaaVRE and can publish technical papers
  that demonstrate the relevance of NaaVRE in the field of networked systems.
  * [User supporter](readiness_levels/Virtual_lab_roles/User_supporter): Can support users. Knows the potential and limitations of the lab and can help out when problems arise.
  * [Infrastructure supporter](readiness_levels/Virtual_lab_roles/Infrastructure_supporter): Ensures there is infrastructure that allows the virtual lab to be used by multiple users.
...
<ul style={{ listStyleType: 'none' }}>
    <li> <Downward_arrow text="L0"/> [Initial proposal](readiness_levels/L0_initial_proposal): <div>The initial proposal of a virtual lab, with conceptual definition but no technical setup. </div></li>
    <li> <Downward_arrow text="L1"/> [Co-development](readiness_levels/L1_co-development): <div>A provisioned virtual lab that is ready for the core development team to implement the virtual lab functionality, e.g. new components, workflows, or experiments. </div></li>
    <li> <Downward_arrow text="L2"/> [Validation phase](readiness_levels/L2_validation_phase): <div>A provisioned virtual lab with developed components. It is ready to run scientific experiments to validate the virtual lab and write scientific publications. </div></li>
    <li> <Downward_arrow text="L3"/> [Workshop use](readiness_levels/L3_workshop_use): <div>A provisioned virtual lab with validated components and scientific stories. It is ready to engage more users through training and hackathons under controlled conditions. </div></li>
    <li> <Downward_arrow text="L4"/> [Operational service](readiness_levels/L4_operational_service): <div>A provisioned virtual lab on operational infrastructure. It is ready to be operational for serving users from the general public. </div></li>
</ul>
