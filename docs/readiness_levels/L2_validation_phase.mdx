...
* VRE researcher: Publishes a technical paper.
...
All of the following boxes should be checked, in addition to the criteria for the initial proposal, and co-development:
